    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('execution_type', models.CharField(choices=[('limit', 'Limit'), ('market', 'Market')], default='limit', max_length=20)),
                ('price', models.DecimalField(decimal_places=8, max_digits=24)),
                ('amount', models.DecimalField(decimal_places=8, max_digits=24)),
                ('total_in_usd', models.DecimalField(blank=True, decimal_places=8, max_digits=24, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('buyer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='purchases', to='user_account.user')),
                ...
                ('seller', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sales', to='user_account.user')),
            ],
        ),
        migrations.CreateModel(
            name='TradingPair',
